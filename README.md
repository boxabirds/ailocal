...
# 3. Run the bench (3 agent-loop tasks, prints wall + tok/s)
./bench.sh
```

The installer handles: prereq checks (Apple Silicon, RAM, disk, Xcode CLT), `uv` install, HuggingFace auth verification, model download, mlx-lm setup, and pi.dev wiring.
